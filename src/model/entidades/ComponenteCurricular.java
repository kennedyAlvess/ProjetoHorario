...
public class ComponenteCurricular {
    ...
    public ComponenteCurricular(String nome, short cargaHoraria, String codigo, String preRequisito, String modalidade) {
        this.nome = nome;
        this.cargaHoraria = cargaHoraria;
        this.codigo = codigo;
    ...
    public ComponenteCurricular(String nome, short cargaHoraria, String codigo, String preRequisito,
            String modalidade, String[] equivalentes) {
        this.nome = nome;
        this.cargaHoraria = cargaHoraria;
        this.codigo = codigo;
        this.preRequisito = preRequisito;
